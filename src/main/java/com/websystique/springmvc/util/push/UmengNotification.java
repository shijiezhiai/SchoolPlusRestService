...
public abstract class UmengNotification {
	...
	protected static final HashSet<String> ROOT_KEYS = new HashSet<>(
			Arrays.asList(new String[] {
				"appkey", "timestamp", "type", "device_tokens", "alias", "alias_type",
                "file_id", "filter", "production_mode", "feedback", "description",
                "thirdparty_id"
			}));
	
	// Keys can be set in the policy level
	protected static final HashSet<String> POLICY_KEYS = new HashSet<>(
			Arrays.asList(new String[] {
